...
public class DatabaseSeeder {
    @Bean
    public CommandLineRunner seedDatabase(UserService userService, BookRepository bookRepository) {
        return args -> {
            if (userService.getUserByEmail("admin@bookstore.com").isEmpty()) {

                UserRegistrationDTO adminDto = new UserRegistrationDTO();
                adminDto.setName("Administrator");
                adminDto.setEmail("admin@bookstore.com");

                adminDto.setPassword("Admin_2026!");
            ...
            if (bookRepository.count() == 0) {
                List<Book> defaultBooks = List.of(
                        ...
                        buildBook("A-BA-BA-HA-LA-MA-HA: Best Verse", "Various Authors", "Poetry", "CHILD", 20.00, "2020-01-01", 120, "UKRAINIAN", "Highly illustrated children anthology series.", "Large format color plates"),
